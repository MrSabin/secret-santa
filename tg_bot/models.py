...
class Bonus(models.Model):
    ...
    game_bonus = models.PositiveSmallIntegerField(
        verbose_name='Премиальное участие в игре Тайный Санта',
...
class UserSantaGame(models.Model):
    ...
    first_name = models.CharField(
        max_length=40, verbose_name='Имя', null=True)
    email = models.EmailField(blank=True)
    is_game_start = models.BooleanField(
        default=False, null=True, blank=True, verbose_name='Создатель игры')
    partner = models.ForeignKey('self',
                                on_delete=models.CASCADE,
                                related_name='partners',
                                null=True, blank=True,
                                verbose_name='Ваш партнер')
    my_wish = models.TextField(verbose_name='Пожелание', blank=True, null=True)
    my_game = models.ForeignKey(Game, on_delete=models.CASCADE,
                                related_name='users',
                                null=True,
                                blank=True,
